    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            GetEnrollmentsRequest theRequest;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetEnrollments)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetEnrollments that = ((GetEnrollments) object);
        {
            GetEnrollmentsRequest lhsRequest;
            lhsRequest = this.getRequest();
            GetEnrollmentsRequest rhsRequest;
