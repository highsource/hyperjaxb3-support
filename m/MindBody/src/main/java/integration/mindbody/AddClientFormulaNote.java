...
@Entity(name = "AddClientFormulaNote")
@Table(name = "ADDCLIENTFORMULANOTE")
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            AddClientFormulaNoteRequest theRequest;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AddClientFormulaNote)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final AddClientFormulaNote that = ((AddClientFormulaNote) object);
        {
            AddClientFormulaNoteRequest lhsRequest;
            lhsRequest = this.getRequest();
            AddClientFormulaNoteRequest rhsRequest;
