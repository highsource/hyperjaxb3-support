...
@Entity(name = "UpdateClientVisits")
@Table(name = "UPDATE_CLIENT_VISITS")
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            UpdateClientVisitsRequest theRequest;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof UpdateClientVisits)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final UpdateClientVisits that = ((UpdateClientVisits) object);
        {
            UpdateClientVisitsRequest lhsRequest;
            lhsRequest = this.getRequest();
            UpdateClientVisitsRequest rhsRequest;
