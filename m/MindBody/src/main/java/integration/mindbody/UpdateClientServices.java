...
@Entity(name = "UpdateClientServices")
@Table(name = "UPDATECLIENTSERVICES")
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            UpdateClientServicesRequest theRequest;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof UpdateClientServices)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final UpdateClientServices that = ((UpdateClientServices) object);
        {
            UpdateClientServicesRequest lhsRequest;
            lhsRequest = this.getRequest();
            UpdateClientServicesRequest rhsRequest;
