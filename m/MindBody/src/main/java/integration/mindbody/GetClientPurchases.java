...
@Entity(name = "GetClientPurchases")
@Table(name = "GETCLIENTPURCHASES")
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            GetClientPurchasesRequest theRequest;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetClientPurchases)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetClientPurchases that = ((GetClientPurchases) object);
        {
            GetClientPurchasesRequest lhsRequest;
            lhsRequest = this.getRequest();
            GetClientPurchasesRequest rhsRequest;
