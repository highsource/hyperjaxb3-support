    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            Integer theSaleID;
            theSaleID = this.getSaleID();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "saleID", theSaleID), currentHashCode, theSaleID);
        }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetClientPurchasesRequest)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final GetClientPurchasesRequest that = ((GetClientPurchasesRequest) object);
        {
            String lhsClientID;
        ...
        {
            Integer lhsSaleID;
            lhsSaleID = this.getSaleID();
            Integer rhsSaleID;
            rhsSaleID = that.getSaleID();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "saleID", lhsSaleID), LocatorUtils.property(thatLocator, "saleID", rhsSaleID), lhsSaleID, rhsSaleID)) {
                return false;
            }
        }
        return true;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            Integer theSaleID;
            theSaleID = this.getSaleID();
            strategy.appendField(locator, this, "saleID", buffer, theSaleID);
        }
        return buffer;
    }
