...
@Entity(name = "GetClientReferralTypes")
@Table(name = "GETCLIENTREFERRALTYPES")
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            GetClientReferralTypesRequest theRequest;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetClientReferralTypes)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetClientReferralTypes that = ((GetClientReferralTypes) object);
        {
            GetClientReferralTypesRequest lhsRequest;
            lhsRequest = this.getRequest();
            GetClientReferralTypesRequest rhsRequest;
