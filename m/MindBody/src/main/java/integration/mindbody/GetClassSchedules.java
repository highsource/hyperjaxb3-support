    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            GetClassSchedulesRequest theRequest;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetClassSchedules)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetClassSchedules that = ((GetClassSchedules) object);
        {
            GetClassSchedulesRequest lhsRequest;
            lhsRequest = this.getRequest();
            GetClassSchedulesRequest rhsRequest;
