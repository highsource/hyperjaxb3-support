    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetActiveClientMembershipsRequest)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final GetActiveClientMembershipsRequest that = ((GetActiveClientMembershipsRequest) object);
        {
            String lhsClientID;
        ...
        {
            Integer lhsLocationID;
            lhsLocationID = this.getLocationID();
            Integer rhsLocationID;
