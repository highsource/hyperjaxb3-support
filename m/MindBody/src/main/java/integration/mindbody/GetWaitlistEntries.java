    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            GetWaitlistEntriesRequest theRequest;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetWaitlistEntries)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetWaitlistEntries that = ((GetWaitlistEntries) object);
        {
            GetWaitlistEntriesRequest lhsRequest;
            lhsRequest = this.getRequest();
            GetWaitlistEntriesRequest rhsRequest;
