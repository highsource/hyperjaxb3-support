    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            GetClassDescriptionsRequest theRequest;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetClassDescriptions)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetClassDescriptions that = ((GetClassDescriptions) object);
        {
            GetClassDescriptionsRequest lhsRequest;
            lhsRequest = this.getRequest();
            GetClassDescriptionsRequest rhsRequest;
