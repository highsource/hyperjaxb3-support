...
@Entity(name = "GetClientFormulaNotes")
@Table(name = "GETCLIENTFORMULANOTES")
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            GetClientFormulaNotesRequest theRequest;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetClientFormulaNotes)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetClientFormulaNotes that = ((GetClientFormulaNotes) object);
        {
            GetClientFormulaNotesRequest lhsRequest;
            lhsRequest = this.getRequest();
            GetClientFormulaNotesRequest rhsRequest;
