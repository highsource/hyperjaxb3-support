...
@Entity(name = "AddOrUpdateClients")
@Table(name = "ADDORUPDATECLIENTS")
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            AddOrUpdateClientsRequest theRequest;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AddOrUpdateClients)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final AddOrUpdateClients that = ((AddOrUpdateClients) object);
        {
            AddOrUpdateClientsRequest lhsRequest;
            lhsRequest = this.getRequest();
            AddOrUpdateClientsRequest rhsRequest;
