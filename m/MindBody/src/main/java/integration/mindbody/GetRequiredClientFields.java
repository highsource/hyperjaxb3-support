...
@Entity(name = "GetRequiredClientFields")
@Table(name = "GETREQUIREDCLIENTFIELDS")
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            GetRequiredClientFieldsRequest theRequest;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetRequiredClientFields)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetRequiredClientFields that = ((GetRequiredClientFields) object);
        {
            GetRequiredClientFieldsRequest lhsRequest;
            lhsRequest = this.getRequest();
            GetRequiredClientFieldsRequest rhsRequest;
