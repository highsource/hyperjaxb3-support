    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theUnpaidsOnly;
            theUnpaidsOnly = this.isUnpaidsOnly();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "unpaidsOnly", theUnpaidsOnly), currentHashCode, theUnpaidsOnly);
        }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetClientVisitsRequest)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final GetClientVisitsRequest that = ((GetClientVisitsRequest) object);
        {
            String lhsClientID;
        ...
        {
            boolean lhsUnpaidsOnly;
            lhsUnpaidsOnly = this.isUnpaidsOnly();
            boolean rhsUnpaidsOnly;
            rhsUnpaidsOnly = that.isUnpaidsOnly();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "unpaidsOnly", lhsUnpaidsOnly), LocatorUtils.property(thatLocator, "unpaidsOnly", rhsUnpaidsOnly), lhsUnpaidsOnly, rhsUnpaidsOnly)) {
                return false;
            }
        }
        return true;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            boolean theUnpaidsOnly;
            theUnpaidsOnly = this.isUnpaidsOnly();
            strategy.appendField(locator, this, "unpaidsOnly", buffer, theUnpaidsOnly);
        }
        return buffer;
    }
