...
@Entity(name = "AddArrival")
@Table(name = "ADDARRIVAL")
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AddArrival)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final AddArrival that = ((AddArrival) object);
        {
            AddArrivalRequest lhsRequest;
            lhsRequest = this.getRequest();
            AddArrivalRequest rhsRequest;
